...
class GoogleLogin:
    ...
    def get_token(self) -> SnsLoginItem:
        data = {
            ...
            'redirect_uri': 'http://localhost:8888/api/users/callback/google',
...
class KakaoLogin:
    ...
    def get_token(self) -> SnsLoginItem:
        data = {
            ...
            'redirect_uri': 'http://localhost:8888/api/users/callback/kakao',
            'code': self.code,
        }
...
class FacebookLogin:
    ...
    def get_token(self) -> SnsLoginItem:
        params = {
            ...
            'code': self.code,
            'redirect_uri': 'http://localhost:8888/api/users/callback/facebook',
        }
...
class NaverLogin:
    ...
    def get_token(self) -> SnsLoginItem:
        params = {
            ...
            'code': self.code,
            'state': self.code,
            'redirect_uri': 'http://localhost:8888/api/users/callback/naver',
        }
...
class GithubLogin:
    ...
    def get_token(self) -> SnsLoginItem:
        params = {
            ...
            'code': self.code,
            'redirect_uri': 'http://localhost:8888/api/users/callback/github',
        }
